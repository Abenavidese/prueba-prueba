...
a persistence unit "pruebaintentoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pruebaintento/pom.xml":
...
artifact ("pruebaintento.war") is already built. You can build
